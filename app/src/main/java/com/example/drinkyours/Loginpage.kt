...
class Loginpage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            CustamerDetails.edit().putString("custamer_mail", cus_mail).apply()
            CustamerDetails.edit().putString("custamer_password", cus_pass).apply()
        }

        button2.setOnClickListener {
//            startActivity(Intent(this,Navigations::class.java))
            val custa_mail = CustamerDetails.getString("custamer_mail", "vjita22@gmail.com")
            val custa_password = CustamerDetails.getString("custamer_password", "9876543210")
